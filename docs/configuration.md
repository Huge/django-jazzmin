...
JAZZMIN_SETTINGS = {
    ...
    # Custom icons for side menu apps/models See https://fontawesome.com/search?m=free&o=r for the full list of free icon classes. `fas` means solid, `fab` means brands etc.
    "icons": {
...
```python
    "custom_links": {
        "books": [{
            ...
            # any font-awesome icon, see list here https://fontawesome.com/search?m=free&o=r for the full list of free icon classes. `fas` means solid, `far` for fa-regular etc.
            "icon": "fas fa-comments",                  
